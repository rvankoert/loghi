...
docker run --rm -v $input_model_path:$input_model_path -v $output_model_path_dirname:$output_model_path_dirname loghi/docker.htr:2.2.18 \
    bash -c "python3 -m pip install -r /src/loghi-htr/utils/convert-v2-to-v3/requirements.txt
python3 /src/loghi-htr/utils/convert-v2-to-v3/convert.py --savedmodel_dir $input_model_path --output_file $output_model_path
"

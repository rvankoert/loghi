...
```{tip}
Below are two tips that may be useful for those unfamiliar with the terminal and Bash:
...
2. You can easily get the full path to a folder or file by right-clicking on it in the file manager, selecting "Copy", and pressing `Ctrl + Shift + V` to paste it into the terminal.
```

    ...
    with gr.Blocks(title="Loghi Demo") as demo:
        ...
        with gr.Tab("Inputs"):
            with gr.Row():
                ...
                with gr.Column():
                    ...
                    status_message = gr.Text(label="Status Message", value="Upload an image...", lines=1)
        ...
        with gr.Tab("HTR Results"):
            with gr.Row():
                with gr.Column():
                    ...
                    extracted_text_lines = gr.Gallery(label="Extracted Text Lines", preview=True)
            with gr.Row():
                with gr.Column():
        ...
        with gr.Tab("PageXML"):
            with gr.Column():
                ...
                download_pagexml = gr.DownloadButton(label="Download PageXML", variant="primary")
        ...
        clear_button.click(
            fn=lambda: (None, None, None, None, None, "Upload an image...", None, None),
            outputs=[
                original_image,
                original_image_display,
                segmented_image,
...
if __name__ == "__main__":
    ...
    concurrency_limit = int(get_env_variable("CONCURRENCY_LIMIT", default_value=2))
    ...
    tooling_address = get_env_variable("TOOLING_ADDRESS", "http://localhost:8080")
